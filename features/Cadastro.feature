...
Cenario: Cadastrar usuario na casasbahia
  ...
  E preencho o "field_Confirm_Email" com "bruno01@bruno.com"
  E preencho o "field_Password" com "Teste123"
  E preencho o "field_Confirm_Password" com "Teste123"
  E não seleciono o "rb_Receive_Offer"
  E não seleciono o "rb_Receive_Sms"
  E clico no "btn_Continue_Save"
